...
insert into tb_categorias(nome, descricao) values ('medicamentos', 'remédios');
insert into tb_categorias(nome, descricao) values ('beleza', 'maquiagem e itens de beleza');
insert into tb_categorias(nome, descricao) values ('outros', 'itens de primeira necessidade');
insert into tb_categorias(nome, descricao) values ('conveniencia', 'bebidas, doces e snacks');
insert into tb_categorias(nome, descricao) values ('higiene pessoal','itens de higiene pessoal');
